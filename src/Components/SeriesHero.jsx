...
const SeriesSearchBar=React.lazy(()=>import('./SeriesSearchBar'))
export default function () {
    ...
    useEffect(()=>{
        ...
        axios
          ...
          .then(function (response) {
            console.log("The SeriesResponse is",response);
            setPoster("https://image.tmdb.org/t/p/original/"+response.data.results[1].backdrop_path)
  ...
  return (
    <div className='w-screen h-full relative'>
        ...
        <img className='w-full h-full bg-red-500 object-cover bg-opacity-30' src={poster} alt="" />
